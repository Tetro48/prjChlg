...
public partial class @Inputs: IInputActionCollection2, IDisposable
{
    ...
    private List<IGamemapsActions> m_GamemapsActionsCallbackInterfaces = new List<IGamemapsActions>();
    ...
    public struct GamemapsActions
    {
        ...
        public void AddCallbacks(IGamemapsActions instance)
        {
            if (instance == null || m_Wrapper.m_GamemapsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_GamemapsActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IGamemapsActions instance)
        {
            @Movement.started -= instance.OnMovement;
            @Movement.performed -= instance.OnMovement;
            @Movement.canceled -= instance.OnMovement;
        ...
        public void RemoveCallbacks(IGamemapsActions instance)
        {
            if (m_Wrapper.m_GamemapsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IGamemapsActions instance)
        {
            foreach (var item in m_Wrapper.m_GamemapsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_GamemapsActionsCallbackInterfaces.Clear();
